#import "AndroidAzurePlugin.h"
#import "Constants.h"
@implementation AndroidAzurePlugin
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"android_azure_plugin"
            binaryMessenger:[registrar messenger]];
  AndroidAzurePlugin* instance = [[AndroidAzurePlugin alloc] initWithChannel:channel];
